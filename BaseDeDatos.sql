...
CREATE TABLE Ejercicio (
    ...
    FOREIGN KEY (Tipo_Id) REFERENCES Tipo_Ejercicio(Id)
);
...
CREATE TABLE Entrenamiento_Ejercicio (
    ...
    FOREIGN KEY (Sesion_de_Entrenamiento_Id) REFERENCES Sesion_de_Entrenamiento(Id),
    FOREIGN KEY (Sesion_de_Ejercicio_Id) REFERENCES Sesion_de_Ejercicio(Id)
);
...
CREATE TABLE Rutina_Semanal_Entrenamiento (
    ...
    FOREIGN KEY (Rutina_Semanal_Id) REFERENCES Rutina_Semanal(Id),
    FOREIGN KEY (Sesion_de_Entrenamiento_Id) REFERENCES Sesion_de_Entrenamiento(Id)
);
