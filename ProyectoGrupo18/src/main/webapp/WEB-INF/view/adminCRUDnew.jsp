...
<form method="post" action="/admin/guardarCRUD">
    <input type="hidden" name="id" value="<%= filtro.getId() %>">
    ...
    <%
            ...
            //sesion:
    %>
   <h1>Sesion de ejercicio</h1>
    <table border="0">
        <tr>
            <td>Repeticiones:</td>
            <td><input type="number" name="SeRep" size="5"  maxlength="5"  value="<%=filtro.getseRepeticiones()!=null?filtro.getseRepeticiones():""%>"/></td>
        </tr>
        <tr>
            <td>Cantidad:</td>
