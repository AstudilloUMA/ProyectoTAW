...
<%
    UsuarioEntity usuarioUI = (UsuarioEntity) request.getSession().getAttribute("usuario");
...
<div class="navbar">
    ...
    <div class="navbar-right">
        <a href="/infoUsuario?id=<%=usuarioUI.getId()%>&tipo=dietista"><button><%=usuarioUI.getNombre()%></button></a>
